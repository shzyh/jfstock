...
# @Last Modified time: 2019-04-23 14:05:58

import pymysql
from conf import mod_config
...
log_path = os.path.split(os.path.realpath(__file__))[0] + r'\log'
log_file = os.path.join(log_path,'db_log.log') 
logger = mod_logger.logger(log_file)
